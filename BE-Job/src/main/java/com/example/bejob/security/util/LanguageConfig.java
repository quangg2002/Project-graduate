...
public class LanguageConfig implements WebMvcConfigurer {
    ...
    public LocaleResolver getLocalResolver() {
        ...
        resolver.setDefaultLocale(Locale.ENGLISH); // #TODO: Check client want which default language
        return resolver;
    }
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(new AcceptLanguageInterceptor(getLocalResolver()));
    }
}
