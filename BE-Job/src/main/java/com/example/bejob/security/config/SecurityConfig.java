package com.example.bejob.security.config;

import com.example.bejob.security.service.UserService;
...
public class SecurityConfig {
    ...
    private final String[] SYSTEM_WHITELIST = {"/ws/**","/video-call/**","/actuator/**", "/v3/**", "/webjars/**", "/swagger-ui*/*swagger-initializer.js", "/swagger-ui*/**", "public/cv/**"};
