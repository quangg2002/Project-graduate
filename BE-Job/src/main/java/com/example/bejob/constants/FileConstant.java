...
public class FileConstant {
    ...
    public static final int FILE_BUSINESS_UPLOAD_SIZE_MAX = 10 * 1024 * 1024; // Max size is 10MB
    public static final int FILE_ACHIEVEMENT_UPLOAD_SIZE_MAX = 10 * 1024 * 1024; // Max size is 10MB
}
